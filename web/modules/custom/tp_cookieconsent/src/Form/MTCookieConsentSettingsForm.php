...
namespace Drupal\tp_cookieconsent\Form;
 ...
 *
 * @package Drupal\tp_cookieconsent\Form
 *
 * @ingroup tp_cookieconsent
 */
class MTCookieConsentSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('tp_cookieconsent.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('tp_cookieconsent.settings')
