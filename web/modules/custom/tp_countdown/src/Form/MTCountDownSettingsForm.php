...
namespace Drupal\tp_countdown\Form;
 ...
 *
 * @package Drupal\tp_countdown\Form
 *
 * @ingroup tp_countdown
 */
class MTCountDownSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('tp_countdown.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('tp_countdown.settings')
