  ...
  Drupal.behaviors.tpslflexsliderInPage = {
    attach: function (context, settings) {
      ...
      $(context).find('.in-page-images-slider').once('tpslflexsliderInPageSliderInit').each(function() {
        $(this).flexslider({
          useCSS: false,
          animation: drupalSettings.schools.flexsliderInPageInit.inPageSliderEffect,
          controlNav: false,
          directionNav: false,
          animationLoop: false,
          slideshow: false,
      ...
      $(context).find('.in-page-images-carousel').once('tpslflexsliderInPageCarouselInit').each(function() {
